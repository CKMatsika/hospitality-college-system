                ...
                <div class="p-6">
                    <form action="{{ route('library.loans.store') }}" method="POST">
                        ...
                        <div class="mt-6">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Add any notes about this book loan.</p>
                            @error('notes')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mt-8 flex justify-end space-x-4">
                            <a href="{{ route('library.loans.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white font-medium py-2 px-4 rounded-lg transition-colors">
                                Cancel
                            </a>
